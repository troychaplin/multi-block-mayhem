...
/***/ "./src/blocks/image-collage-image/block.json":
/*!***************************************************!*\
  !*** ./src/blocks/image-collage-image/block.json ***!
  \***************************************************/
/***/ ((module) => {
...
/***/ "./src/blocks/image-collage-image/edit.js":
/*!************************************************!*\
  !*** ./src/blocks/image-collage-image/edit.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/image-collage-image/editor.scss");
...
function Edit({
  ...
  const imageSize = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => {
    return columnSpan === 1 ? 'medium' : 'large';
  }, [columnSpan]);

  // Memoize the minimum dimensions based on column span
  const minDimensions = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => {
    return {
...
/***/ "./src/blocks/image-collage-image/editor.scss":
/*!****************************************************!*\
  !*** ./src/blocks/image-collage-image/editor.scss ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/image-collage-image/index.js":
/*!*************************************************!*\
  !*** ./src/blocks/image-collage-image/index.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/image-collage-image/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./src/blocks/image-collage-image/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/blocks/image-collage-image/block.json");
...
/***/ "./src/blocks/image-collage-image/style.scss":
/*!***************************************************!*\
  !*** ./src/blocks/image-collage-image/style.scss ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const CustomImageUploader = ({
  ...
  const hasMinimumDimensions = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
    if (!attributes?.imageWidth) {
      return true;
    }
    return (!minWidth || attributes.imageWidth >= minWidth) && (!minHeight || attributes.imageHeight >= minHeight);
  }, [attributes?.imageWidth, attributes?.imageHeight, minWidth, minHeight]);

  // Memoize the recommendation message
  const recommendationMessage = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
   ...
   */
  const removeImage = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => {
    setImageUrl(null);
    setAttributes({
      imageUrl: '',
      imageId: null,
  ...
  const uploaderControls = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.MediaUpload, {
    onSelect: onSelectImage,
    allowedTypes: ['image'],
    value: imageId,
    render: ({
      open
    }) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ButtonGroup, {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
    ...
    children: [showWarning && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Notice, {
      status: "warning",
      isDismissible: false,
      className: "mbm-image-warning",
      children: ["Current image size (", attributes.imageWidth, "px \xD7", ' ', attributes.imageHeight, "px) is smaller than recommended", ' ', recommendationMessage]
    }), (minWidth || minHeight) && !imageUrl && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
...
CustomImageUploader.propTypes = {
  ...
  imageSize: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().string),
  minWidth: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().number),
  minHeight: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().number),
  attributes: prop_types__WEBPACK_IMPORTED_MODULE_4___default().shape({
    imageId: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().number),
    imageWidth: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().number),
    imageHeight: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().number)
  }),
  force: (prop_types__WEBPACK_IMPORTED_MODULE_4___default().bool)
};
...
/******/ 		var installedChunks = {
/******/ 			"blocks/image-collage-image/index": 0,
/******/ 			"blocks/image-collage-image/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/image-collage-image/style-index"], () => (__webpack_require__("./src/blocks/image-collage-image/index.js")))
